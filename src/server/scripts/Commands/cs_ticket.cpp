...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "append",         SEC_GM,      true,  &HandleGMTicketResponseAppendCommand,    "", NULL },
            { "appendln",       SEC_GM,      true,  &HandleGMTicketResponseAppendLnCommand,  "", NULL },
            { NULL,             0,                  false, NULL,                                    "", NULL }
        };
        static ChatCommand ticketCommandTable[] =
        {
            { "assign",         SEC_HGM,     true,  &HandleGMTicketAssignToCommand,          "", NULL },
            { "close",          SEC_GM,      true,  &HandleGMTicketCloseByIdCommand,         "", NULL },
            { "closedlist",     SEC_GM,      true,  &HandleGMTicketListClosedCommand,        "", NULL },
            { "comment",        SEC_GM,      true,  &HandleGMTicketCommentCommand,           "", NULL },
            { "complete",       SEC_GM,      true,  &HandleGMTicketCompleteCommand,          "", NULL },
            { "delete",         SEC_ADMINISTRATOR,  true,  &HandleGMTicketDeleteByIdCommand,        "", NULL },
            { "escalate",       SEC_GM,      true,  &HandleGMTicketEscalateCommand,          "", NULL },
            { "escalatedlist",  SEC_HGM,     true,  &HandleGMTicketListEscalatedCommand,     "", NULL },
            { "list",           SEC_GM,      true,  &HandleGMTicketListCommand,              "", NULL },
            { "onlinelist",     SEC_GM,      true,  &HandleGMTicketListOnlineCommand,        "", NULL },
            { "reset",          SEC_ADMINISTRATOR,  true,  &HandleGMTicketResetCommand,             "", NULL },
            { "response",       SEC_GM,      true,  NULL,                                    "", ticketResponseCommandTable },
            { "togglesystem",   SEC_ADMINISTRATOR,  true,  &HandleToggleGMTicketSystem,             "", NULL },
            { "unassign",       SEC_HGM,     true,  &HandleGMTicketUnAssignCommand,          "", NULL },
            { "viewid",         SEC_GM,      true,  &HandleGMTicketGetByIdCommand,           "", NULL },
            { "viewname",       SEC_GM,      true,  &HandleGMTicketGetByNameCommand,         "", NULL },
            { NULL,             0,                  false, NULL,                                    "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "ticket",         SEC_GM,      false, NULL,                                    "", ticketCommandTable },
            { NULL,             0,                  false, NULL,                                    "", NULL }
        };
        return commandTable;
    }
