...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "kill",           SEC_HGM,     false, &HandleHonorAddKillCommand,         "", NULL },
            { "",               SEC_HGM,     false, &HandleHonorAddCommand,             "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };

        static ChatCommand honorCommandTable[] =
        {
            { "add",            SEC_HGM,     false, NULL,               "", honorAddCommandTable },
            { "update",         SEC_HGM,     false, &HandleHonorUpdateCommand,          "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };

        static ChatCommand commandTable[] =
        {
            { "honor",          SEC_HGM,     false, NULL,                  "", honorCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
