...
class Professions_NPC : public CreatureScript
{
        public:
                ...
                {
                        pPlayer->ADD_GOSSIP_ITEM(9, "|cffff0000Click here to continue...", GOSSIP_SENDER_MAIN, 197);
                        pPlayer->PlayerTalkClass->SendGossipMenu(70006, _creature->GetGUID());
                        return true;
                }
                ...
                void CompleteLearnProfession(Player *pPlayer, Creature *pCreature, SkillType skill)
                {
                        if (PlayerAlreadyHasTwoProfessions(pPlayer) && !IsSecondarySkill(skill))
                                pCreature->MonsterWhisper("You already know two professions, you must unlearn one to be able to learn another..", pPlayer->GetGUID());
                        else
                        {
                        ...
                        if (uiSender == GOSSIP_SENDER_MAIN)
                        {
                                ...
                                switch (uiAction)
                                {
                                        ...
                                        case 1:
												...
												m_session->SendNotification("Alchemy Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
                                        case 2:
                                                CompleteLearnProfession(pPlayer, _creature, SKILL_BLACKSMITHING);
												m_session->SendNotification("Blacksmithing Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
                                        case 3:
                                                CompleteLearnProfession(pPlayer, _creature, SKILL_LEATHERWORKING);
												m_session->SendNotification("Leatherworking Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
                                        case 4:
                                                CompleteLearnProfession(pPlayer, _creature, SKILL_TAILORING);
												m_session->SendNotification("Tailoring Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
                                        case 5:
                                                CompleteLearnProfession(pPlayer, _creature, SKILL_ENGINEERING);
												m_session->SendNotification("Engineering Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
                                        case 6:
                                                CompleteLearnProfession(pPlayer, _creature, SKILL_ENCHANTING);
												m_session->SendNotification("Enchanting Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
                                        case 7:
                                                CompleteLearnProfession(pPlayer, _creature, SKILL_JEWELCRAFTING);
												m_session->SendNotification("Jewelcrafting Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
                                        case 8:
                                                CompleteLearnProfession(pPlayer, _creature, SKILL_INSCRIPTION);
												m_session->SendNotification("Inscription Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
                                        case 9:
												CompleteLearnProfession(pPlayer, _creature, SKILL_COOKING);
                                                m_session->SendNotification("Cooking Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
                                        case 10:
												CompleteLearnProfession(pPlayer, _creature, SKILL_FIRST_AID);
												m_session->SendNotification("First Aid Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
										case 11:
												CompleteLearnProfession(pPlayer, _creature, SKILL_HERBALISM);
												m_session->SendNotification("Herbalism Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
										case 12:
												CompleteLearnProfession(pPlayer, _creature, SKILL_SKINNING);
												m_session->SendNotification("Skining Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
										case 13:
												CompleteLearnProfession(pPlayer, _creature, SKILL_MINING);
												m_session->SendNotification("Mining Learned, skills updated to 450... skills learned!");
                                                pPlayer->PlayerTalkClass->SendCloseGossip();
                                                break;
                                }
